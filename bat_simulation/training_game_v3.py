...
from constants import (ANGLE_RANGE, BAT_OBSERVABLE_DISTANCE, BAT_SPEED,
                       ...
                       NUM_OBSTABLES, OFFSET, PRINT_PATH, RANDOM_OBSTACLES,
                       REWARD_BETTER_DISTANCE, REWARD_GOAL, REWARD_HIT_TREE,
                       REWARD_MOVE, REWARD_ON_EDGE, SHAPE_FILE, SITE_MARGIN)
...
class Game:
    ...
    def __init__(self, model: Dqn, experiment_number: int):
        ...
        bat_y = random.randint(
            SITE_MARGIN, self.height - SITE_MARGIN)
    ...
    def _init_goal(self):
        self.state.goal_x = self.width - SITE_MARGIN
